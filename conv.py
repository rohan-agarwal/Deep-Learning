...
# build symbolic expression to add bias
# and apply activation function, i.e. produce neural net layer output
...
img = Image.open(
    "C:\Users\Rohan\Documents\GitHub\Deep-Learning\Data\one.png")
