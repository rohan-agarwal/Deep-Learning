    ...
    \begin{document}
        ...
        \section{Implementation}
            ...
            The task list at hand is therefore to do the following:
                ...
                \begin{enumerate}
                    ...
                    \item Implement the SDA structure
                    \item Create a padding function in Theano for images
                    \item Create a least squares cost function for a convolutional neural network in Theano 
                    \item Implement ODCNN
        ...
        \section{Current Progress}
            ...
            \begin{enumerate}
                ...
                \item \st{Implement the SDA structure}
                \item Create a padding function in Theano for images
                \item \st{Create a least squares cost function for a convolutional neural network in Theano} 
                \item Implement ODCNN
                \item Substitute the last two layers of ODCNN with the previously created SDA and benchmark
